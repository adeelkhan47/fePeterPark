      ...
      <form ref="form" @submit.stop.prevent="handleSubmit">
        ...
        >
          ...
          ></b-form-input>
           ...
           <b-form-group
          label="Start Date"
          label-for="start_date-input"
        >
          <b-form-datepicker id="start_date-input" v-model="start_date" placeholder="Choose Start Date" class="mb-2"></b-form-datepicker></b-form-group>
           <b-form-group
          label="End Date"
          label-for="end_date-input"
        >
          <b-form-datepicker id="end_date-input" v-model="end_date"  placeholder="Choose End Date"  class="mb-2"></b-form-datepicker>
          </b-form-group>
           <b-form-group
          label="Owner Name"
